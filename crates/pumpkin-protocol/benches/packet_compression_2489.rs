...
fn benchmark_case(
    ...
    compress(&mut compressor, &mut compressed, &payload).expect("compression failed");
    ...
    group.bench_with_input(
        ...
        |b, payload| {
            ...
            b.iter(|| {
                black_box(
                    compress(&mut compressor, &mut output, black_box(payload.as_slice()))
...
fn bench_packet_compression(c: &mut Criterion) {
    let mut group = c.benchmark_group("packet_compression_2489");
